...
function findPlace(){
    ...
    for(var i = 0; i < timeZones.length; i++){
        ...
        var testHour = UtcHour + offset;
        var testMins = userDate.getUTCMinutes() + ((timeZones[i].currentTimeOffsetInMinutes/60)-offset)*60;
        var testSuffix;

        if((UtcHour + offset) < 0){
            testHour = (24+testHour)
            testSuffix = "pm";
        }else if((UtcHour + offset) >= 12){
            testHour = testHour;
            testSuffix = "pm";
        }else{
            testHour = testHour;
        ...
        if(testMins >= 60){
            testHour++;
            testMins = testMins-60;
        }
        
        window.localHour = getHour(UtcHour + offset);

        // if mins before 30 irregular offset nums are neg???
        // then the getMins reads neg num and turns it into 5:0-8 or 5:0-2 which is NAN
        // command f "0-" in console to find
...
},{"@vvo/tzdb":4}],2:[function(require,module,exports){
"use strict";
...
},{"luxon":7}],3:[function(require,module,exports){
"use strict";
...
},{"../raw-time-zones.json":5,"./formatTimeZone.js":2,"luxon":7}],4:[function(require,module,exports){
"use strict";
...
},{"../raw-time-zones.json":5,"../time-zones-names.json":6,"./getTimeZones.js":3}],5:[function(require,module,exports){
module.exports=[{"name":"Pacific/Niue","alternativeName":"Niue Time","group":["Pacific/Niue"],"continentCode":"OC","continentName":"Oceania","countryName":"Niue","countryCode":"NU","mainCities":["Alofi"],"rawOffsetInMinutes":-660,"abbreviation":"NUT","rawFormat":"-11:00 Niue Time - Alofi"},
...
{"name":"Africa/Bamako","alternativeName":"Greenwich Mean Time","group":["Africa/Bamako"],"continentCode":"AF","continentName":"Africa","countryName":"Mali","countryCode":"ML","mainCities":["Bamako","Ségou","Sikasso","Mopti"],"rawOffsetInMinutes":0,"abbreviation":"GMT","rawFormat":"+00:00 Greenwich Mean Time - Bamako, Ségou, Sikasso, Mopti"},
...
{"name":"Africa/Juba","alternativeName":"East Africa Time","group":["Africa/Juba"],"continentCode":"AF","continentName":"Africa","countryName":"South Sudan","countryCode":"SS","mainCities":["Juba","Winejok","Malakal","Wau"],"rawOffsetInMinutes":120,"abbreviation":"EAT","rawFormat":"+02:00 East Africa Time - Juba, Winejok, Malakal, Wau"},
