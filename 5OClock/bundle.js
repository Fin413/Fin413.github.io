...
function findPlace(){
    ...
    for(var i = 0; i < timeZones.length; i++){
        ...
        if(localHour == "5" || localHour == "17"){
            ...
            places.push({hour: 5, min: localMins, suffix: suffix, place: timeZones[i].mainCities[getRand(0, timeZones[i].mainCities.length)] + ", " + timeZones[i].countryName, offset: timeZones[i].currentTimeOffsetInMinutes})
        }
    }    

    window.index = getRand(0, places.length);
