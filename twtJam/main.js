...
function readData() {
    ...
    toggleTutorialPrompt(); // remove this !!!
...
function startTutorial() {
    let tutorial = document.getElementById("tutorialOverlay");
...
function endTutorial() {
    let tutorial = document.getElementById("tutorialOverlay");
    document.getElementById("tutorialOverlay").style.visibility = "hidden";
}
