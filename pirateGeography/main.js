...
// if dev console open stop shit look at blind
// add already guessed popup

/*
    SHIT LIST
    - fine tune drag? (Add threshold so it doenst cancel your clicks on the slightest movement)

    - weird restart error
    it says a value is undefined when it's simply not?
    - sometimes the gamebar just appears without the animation
    - do audio not compatible thing
    - change stats page color (looks too similar to map)
    - fix indicator <- is smth wrong???
    - give mroe time for larger maps (world) less for canada
