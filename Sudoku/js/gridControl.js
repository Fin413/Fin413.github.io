...
function showModal(type) {
    ...
    if(type == "hintPopup"){
        ...
        if(window.localStorage.getItem("theme") == "blackWhite"){
            console.log( document.querySelector("input[checkbox]"))
...
var solveSpeed = 10;
var input = document.getElementById("solveSpeedInput")
function changeSpeed(){
    let value = input.innerText.replace(/\s/g, '');
    if(!(isNaN(value) || value < 0 || value == "")){
        solveSpeed = value;
    } 
    input.innerText = solveSpeed;
}
